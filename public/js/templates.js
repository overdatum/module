...
function program3(depth0,data) {
  ...
  stack2 = ((stack1 = helpers.linkTo || depth0.linkTo),stack1 ? stack1.call(depth0, "modules", options) : helperMissing.call(depth0, "linkTo", "modules", options));
  ...
  stack2 = ((stack1 = helpers.linkTo || depth0.linkTo),stack1 ? stack1.call(depth0, "resources", options) : helperMissing.call(depth0, "linkTo", "resources", options));
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("\n    </ul>\n  </div>\n</nav>\n\n<div class=\"container\">\n  <div class=\"row\">\n    <div class=\"col-xs-12\">\n      ");
  hashTypes = {};
  hashContexts = {};
...
function program3(depth0,data) {
  ...
  hashTypes = {};
  hashContexts = {};
  stack1 = helpers.each.call(depth0, "resource", "in", "resources", {hash:{},inverse:self.noop,fn:self.program(1, program1, data),contexts:[depth0,depth0,depth0],types:["ID","ID","ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n							</select>\n						</div>\n					</div>\n					<div class=\"form-group\">\n						<label class=\"col-sm-3 control-label\">Package</label>\n						<div class=\"col-sm-9\">\n							<select class=\"form-control\">\n								");
  hashTypes = {};
  hashContexts = {};
  stack1 = helpers.each.call(depth0, "module", "in", "modules", {hash:{},inverse:self.noop,fn:self.program(3, program3, data),contexts:[depth0,depth0,depth0],types:["ID","ID","ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data});
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
...
function program1(depth0,data) {
  ...
  stack2 = ((stack1 = helpers.linkTo || depth0.linkTo),stack1 ? stack1.call(depth0, "resources.edit", "resource", options) : helperMissing.call(depth0, "linkTo", "resources.edit", "resource", options));
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("\n          ");
  hashContexts = {'class': depth0};
  hashTypes = {'class': "STRING"};
  ...
  stack2 = ((stack1 = helpers.linkTo || depth0.linkTo),stack1 ? stack1.call(depth0, "resources.destroy", "resource", options) : helperMissing.call(depth0, "linkTo", "resources.destroy", "resource", options));
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("\n        </td>\n      </tr>\n      ");
  return buffer;
  }
